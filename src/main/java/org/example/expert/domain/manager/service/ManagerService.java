...
public class ManagerService {
    ...
    public ManagerSaveResponse saveManager(AuthUser authUser, long todoId, ManagerSaveRequest managerSaveRequest) {
        ...
        ManagerLog managerLog = managerLogService.saveManagerLog(authUser.id(), managerSaveRequest.getManagerUserId());
        try {
            ...
            managerLogService.successLog(managerLog); //성공 저장
            ...
            managerLogService.failureLog(managerLog, e.getMessage()); //실패 저장
            throw e;
        }
    }
